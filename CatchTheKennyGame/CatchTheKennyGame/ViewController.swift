...
//  CatchTheKennyGame
//
//  Created by Talha Varol on 18.03.2022.
//
...
//MARK: - @IBOUtlet
    ...
    override func viewDidLoad() {
        ...
        let storedHigh = UserDefaults.standard.object(forKey: "highscore")
        if storedHigh == nil{
            highScore = 0
            highScoreLabel.text = "Hibgh Score: \(highScore)"
        }
        
        if let newScore = storedHigh as? Int{
            highScore = newScore
